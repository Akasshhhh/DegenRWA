...
async function main() {
  ...
  const contractAddress = "0x30Ecb95D0eEee8DA40C7B611ef46e38A2D774De2";
  ...
  try {
    ...
    console.log("Public minting has been enabled");
  } catch (error) {
    console.error("Error setting public minting:", error);
  }
}
